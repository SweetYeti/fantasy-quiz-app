    ...
    <div className="thank-you-confirmation">
      <div className="content-frame">
        ...
        <div className="external-links">
          <a href="https://www.hanna-nygren.com/" target="_blank" rel="noopener noreferrer" className="text-link">
            Visit Website
          </a>
          <span className="separator">|</span>
          <a href="https://www.hanna-nygren.com/category/all-products" target="_blank" rel="noopener noreferrer" className="text-link">
            Visit Shop
          </a>
        </div>
      </div>
